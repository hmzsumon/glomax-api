	...
	<body>
		<div class="container">
			...
			<div class="content">
				...
				<p>
					Your withdrawal request has been successfully processed. You have received amount
					<span style="color: #f9c405"> ${amount}</span>USDT. Please check your crypto wallet.<br />
